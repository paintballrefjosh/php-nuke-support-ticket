...
$license = "GNU/GPL";
$download_location = "http://www.moahosting.com/modules.php?name=Downloads&d_op=viewdownload&cid=2";
$module_version = "2.0";
$module_description = "A PHP-Nuke module for customers to use to receive support via support ticket system!";
